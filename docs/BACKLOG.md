...
Der verbindliche Backlog wird ausschließlich im
[GitHub-Issue-Tracker](https://github.com/cybernoodles/parsedmarc-stack/issues)
gepflegt. Diese Datei ist nur ein Einstiegspunkt und enthält bewusst keine
zweite Kopie der Anforderungen.

## Aktuelle Themen

- [#2 Backup und Wiederherstellung historischer Daten](https://github.com/cybernoodles/parsedmarc-stack/issues/2)
